...
```
mvn archetype:generate -DarchetypeArtifactId=mvnsh-archetype -DarchetypeGroupId=pro.friendlyted -DarchetypeVersion=1.1-SNAPSHOT -DgroupId=group -DartifactId=artifact -Dversion=123
cd artifact
mvn install
mvn pro.friendlyted:mvnsh-maven-plugin:1.1-SNAPSHOT:exec -Dmvnsh.artifact=group/artifact/123/bat/win.one
```
...
```
mvn pro.friendlyted:mvnsh-maven-plugin:1.1-SNAPSHOT:exec -Dmvnsh.artifact=pro.friendlyted/mvnsh-scripts/1.1-SNAPSHOT/bat/win.one
```
...
```
mvn mvnsh:exec -Dmvnsh.artifact=pro.friendlyted/mvnsh-scripts/1.1-SNAPSHOT/bat/win.one
```
