 ...
 * @author frekade
 */
public class MvnshPluginConsts {

    public static final String PARAMETER_PREFIX = "mvnsh.";
    public static final String ARTIFACT_PARAMETER = PARAMETER_PREFIX + "artifact";
